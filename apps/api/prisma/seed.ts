...
async function inputData() {
   ...
   const property2 = await prisma.property.create({
      data: {
         ...
         propertyPictures: {
            create: {
               url: "https://plus.unsplash.com/premium_photo-1729880135754-a031fe7db49e?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxmZWF0dXJlZC1waG90b3MtZmVlZHwyfHx8ZW58MHx8fHx8",
            },
         },
         room: {
            create: [
